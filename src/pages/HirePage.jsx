    ...
    <div className="container mx-auto text-black rubik-font">
      ...
      <div className="my-9">
        <p className="mt-4 text-lg custom-text">
          You can find me and get in touch using the following platforms:
        </p>

        {/* Icons and links */}
        <div className="flex space-x-6 mt-4">
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/sergey-yackushevich-688a4b179/" className="[&>svg]:h-10 [&>svg]:w-10 text-blue-600 hover:text-blue-800">
          ...
          {/* Telegram */}
          <a href="https://t.me/cyberjosef" className="[&>svg]:h-10 [&>svg]:w-10 text-blue-600 hover:text-blue-800">
          ...
          {/* GitHub */}
          <a href="https://github.com/syakushevich" className="[&>svg]:h-10 [&>svg]:w-10 text-blue-600 hover:text-blue-800">
            <svg xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 496 512">
